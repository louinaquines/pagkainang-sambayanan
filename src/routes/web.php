...
Route::middleware(['auth', 'charity.registered'])->group(function () {
    ...
    Route::get('/serve/{path}', [AdminController::class, 'serveFile'])->where('path', '.*')->name('serve');
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        Route::get('/admin/serve/{path}', [AdminController::class, 'serveFile'])->where('path', '.*')->name('admin.serve');
    });
});
