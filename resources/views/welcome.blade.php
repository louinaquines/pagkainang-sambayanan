    ...
    <div class="modal-card">
        ...
        <div class="modal-body">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <a href="{{ url('auth/google') }}?role=donor" class="btn-auth" style="background: white; border: 1px solid #ddd; color: #444; display: flex; align-items: center; justify-content: center; gap: 10px; text-decoration: none; padding: 12px; border-radius: 8px;">
